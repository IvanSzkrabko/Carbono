...
public class Repository {
    ...
    public Repository(){
        ...
        Album soldadura_zac = new Album("Soldadura ZAC", "Acero Alta Aleacion", covers[3]);
        ...
        Album AceroAA = new Album("Aceros Alta Aleacion","",R.drawable.xalta_aleacion,new ArrayList<>(Arrays.asList(falla_forjado,soldadura_zac,estructura_de_bandas,tt_normalizado)));
        albumList.add(AceroAA);
        Album AceroBA = new Album("Aceros Baja Aleacion","",R.drawable.xbaja_aleacion,new ArrayList<>(Arrays.asList(baja_aleacion,tt_defectuoso)));
        albumList.add(AceroBA);
        Album AceroInox = new Album("Acero Inoxidable","",R.drawable.xinoxidable,new ArrayList<>(Arrays.asList(inclusion,soldadura_defectuosa)));
        albumList.add(AceroInox);
        Album Aceros = new Album("Aceros","",R.drawable.xaceros,new ArrayList<>(Arrays.asList(AceroBA,AceroAA,AceroInox)));
        albumList.add(Aceros);
        Album FundicionGris = new Album("Fundicion Gris","",R.drawable.xfund_gris);
        albumList.add(FundicionGris);
        Album FundicionNodular = new Album("Fundicion Nodular","",R.drawable.xfund_nodular);
        albumList.add(FundicionNodular);
        Album FundicionBlanca = new Album("Fundicion Blanca","",R.drawable.xfund_blanca);
        albumList.add(FundicionBlanca);
        Album Fundicion = new Album("Fundicion","",R.drawable.xfundicion,new ArrayList<>(Arrays.asList(FundicionGris,FundicionNodular,FundicionBlanca)));
